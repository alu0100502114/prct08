...
describe Exam do
  before :each do
    ...
    @lista.ins_final(Exam::Question.new('La siguiente definicion de un hash en Ruby es validad: hash_raro = { [1, 2, 3] => Object.new(), Hash.new => :toto }',['Cierto', 'Falso'], 0))
    ...
    @lista.ins_final(Exam::Question.new('Es apropiado que una clase Tablero herede de una clase Juego',['Cierto', 'Falso'], 0))
